...
<html class="js"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link rel="stylesheet" href="./jquery.min_files/reset.css" type="text/css">
		<link rel="stylesheet" href="./jquery.min_files/screen.css" type="text/css">
		<script src="./jquery.min_files/jquery.min.js"></script>
		<script>!window.jQuery && document.write('<script src="http://code.jquery.com/jquery-1.4.2.min.js"><\/script>');</script>
		<script src="./jquery.min_files/custom.js"></script>
	...
	<script type="text/javascript" async="" src="./jquery.min_files/ga.js"></script></head>
	<body class="jq-enhanced hasGoogleVoiceExt">
	<div id="jq-siteContain">
			<div id="jq-header">
				<a id="jq-siteLogo" href="./jquery.min_files/jquery.min.js" title="jQuery Home"><img src="./jquery.min_files/logo_jquery_215x53.gif" width="215" height="53" alt="jQuery: Write Less, Do More."></a>

				<div id="jq-primaryNavigation">
					<ul>
						<li class="jq-jquery jq-current"><a href="./jquery.min_files/jquery.min.js" title="jQuery Home">jQuery</a></li>
      ...
      <div id="jq-content" class="jq-clearfix">
        <a href="http://events.jquery.org/"><img src="./jquery.min_files/sf-2012.png"></a>
				...
				<div id="jq-books" style="width:auto; float: none">
					...
					<ul>
					  <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
							<a href="http://link.packtpub.com/S3Fr9Q" class="jq-bookImg"><img src="./jquery.min_files/ljq3rded.jpg" alt="Learning jQuery Third Edition" width="55" height="70"></a>
  					...
  					<li class="jq-clearfix" style="width:270px;float:left;clear:none;">
  							<a href="http://www.packtpub.com/jquery-1-4-animation-techniques-beginners-guide/book/mid/1803111nkj15" class="jq-bookImg"><img src="./jquery.min_files/jquery-animation-beginners-guide.jpg" alt="jQuery 1.4 Animation Techniques: Beginners Guide" width="55" height="70"></a>
					  ...
					  <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
  							<a href="http://www.packtpub.com/jquery-plugin-development-beginners-guide/book/mid/1911104odmdz" class="jq-bookImg"><img src="./jquery.min_files/jquery-plugin-developers-guide_thumb.jpg" alt="jQuery Plugin Development Beginner&#39;s Guide" width="55" height="70"></a>
						...
						<li class="jq-clearfix" style="width:270px;float:left;clear:left;">
							<a href="http://www.manning.com/affiliate/idevaffiliate.php?id=648_176" class="jq-bookImg"><img src="./jquery.min_files/jquery-in-action-2ed_thumb.jpg" alt="jQuery in Action" width="55" height="70"></a>
						...
						<li class="jq-clearfix" style="width:270px;float:left;clear:none;">
						  <a class="jq-bookImg" href="http://jqueryenlightenment.com/"><img src="./jquery.min_files/jquery-enlightenment_thumb.jpg" alt="jQuery Enlightenment" width="55" height="70"></a>
	...
	<script src="./jquery.min_files/donate.js" type="text/javascript"></script>
