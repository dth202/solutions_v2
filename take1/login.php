      ...
      <div align="center">
        <div id="login_box" class="round shadow">
          ...
          <p style="font-size:10px;">
            Login to start editing and changing site content. If you are having problems email <a href="mailto:webmaster@awdoffice.com">support@intuitiveits.com</a>
          </p>
          ...
          <form class="round" style="background-color:#EEE; width:90%; padding:10px 0px 10px 0px;" action="/includes/sign_in.php" method="post" name="login" id="login">
            <table style="font-family:Tahoma, Geneva, sans-serif; font-size:14px; border:none; background-color:transparent;">
              <tr>
                ...
                <td>
                  <input name="username" type="text" id="username" style="width:119px;" />
                </td>
              </tr>
              <tr>
                <td>Password: </td>
                <td>
                  <input name="password" type="password" id="pass" size="20" style="width:119px;" />
                </td>
              </tr>
            </table>
            <div style="font-family:Verdana, Geneva, sans-serif; font-size:9px; color:#F00;"
              <?php if (!$failed) { echo 'display:none;'; } ?>">
              Last Attempt Failed
            </div>
            <div align="center"; style="padding-left:140px; padding-top:10px;">
              <input name="Submit" type="submit" id="submit" value="Login" style="width:85px;" />
            </div>
          </form>
